                ...
                generateEUI.skins = {};generateEUI.paths['resource/eui_modules/Game/BetLoadingUI.exml'] = window.BetLoadingUI = (function (_super) {
	__extends(BetLoadingUI, _super);
	function BetLoadingUI() {
		_super.call(this);
		...
		this.width = 1080;
		this.loop_i();
		this.elementsContent = [this.rect_i(),this.label_i(),this.light_i()];
	...
	var _proto = BetLoadingUI.prototype;
	...
	return BetLoadingUI;
})(eui.Skin);generateEUI.paths['resource/eui_modules/Game/BuyKeyModal.exml'] = window.BuyKeyModal = (function (_super) {
	...
	_proto.carLine_i = function () {
		...
		t.verticalCenter = 12.575000000000003;
		return t;
	};
	...
	_proto._Image4_i = function () {
		var t = new eui.Image();
		t.horizontalCenter = 0.33499999999999375;
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "car1_png";
		t.verticalCenter = 17.33;
	...
	function GameUI() {
		_super.call(this);
		this.skinParts = ["alertBgBling","jackPotLabel","readyTimeLabel","langJackPot","totalInvestLabel","totalAsset","buyTip","roundBonus","roundBuy","queueNum","myEarningsPanal","myAsset","extractNum","myNum","currentProf","predictBonus","profidImg","keyImg","unionProf","marqueeBg","marqueeLabel","marquee","roundNum","roundZh","roundNum0","roundEn","tips1","statisticsBtn","registerBtn","languageBtn","helpBtn","extractText","extractBtn","showBuyModal","alertBg","alertText","alertModal"];
		
		this.height = 1716;
		this.width = 1080;
		this.alertBgBling_i();
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this._Group3_i(),this._Image6_i(),this._Image7_i(),this._Image8_i(),this.buyTip_i(),this.myEarningsPanal_i(),this._Image13_i(),this._Image14_i(),this._Image15_i(),this._Image16_i(),this.myAsset_i(),this.extractNum_i(),this.myNum_i(),this.currentProf_i(),this.predictBonus_i(),this.profidImg_i(),this.keyImg_i(),this._Image17_i(),this._Image18_i(),this._Image19_i(),this._Image20_i(),this._Label7_i(),this._Image21_i(),this._Label8_i(),this._Label9_i(),this.unionProf_i(),this._Image22_i(),this._Label10_i(),this._Label11_i(),this._Label12_i(),this._Label13_i(),this._Label14_i(),this._Label15_i(),this.marqueeBg_i(),this.marquee_i(),this._Group4_i(),this.tips1_i(),this._Label16_i(),this.statisticsBtn_i(),this.registerBtn_i(),this.languageBtn_i(),this.helpBtn_i(),this.extractBtn_i(),this.showBuyModal_i(),this.alertModal_i()];
	...
	_proto._Image7_i = function () {
		...
		t.height = 61.33;
		t.horizontalCenter = 0.5;
		t.scale9Grid = new egret.Rectangle(194,26,8,6);
	...
	_proto.myEarningsPanal_i = function () {
		...
		t.top = 922;
		t.visible = false;
		t.elementsContent = [this._Image9_i(),this.roundBonus_i(),this.roundBuy_i(),this._Image10_i(),this._Image11_i(),this._Image12_i(),this.queueNum_i(),this._Label3_i(),this._Label4_i(),this._Label5_i(),this._Label6_i()];
		return t;
	};
	_proto._Image9_i = function () {
		var t = new eui.Image();
	...
	_proto.roundZh_i = function () {
		...
		t.x = 9.68;
		t.y = 11.46;
		t.elementsContent = [this._Image23_i(),this.roundNum_i()];
		return t;
	};
	...
	_proto.roundEn_i = function () {
		...
		t.x = 9.68;
		t.y = 11.46;
		t.elementsContent = [this._Image24_i(),this.roundNum0_i()];
		return t;
	};
	...
	_proto.extractBtn_i = function () {
		...
		t.x = 682;
		t.y = 850;
		t.elementsContent = [this._Image25_i(),this.extractText_i()];
		return t;
	};
	...
	_proto.alertModal_i = function () {
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this.alertBg_i(),this.alertText_i()];
		return t;
	};
