...
var $ZHTW = {
    ...
    game: {
        ...
        panalTips1: "同時最多可投放 10 次，每次 3 ETH",
        panalTips2: "剩余投放次數:",
        /**help modal */
        help_text_1: '1. 遊戲怎樣結束？',
        help_text_2: '      遊戲倒計時8小時，玩家每投入1次增加30分鐘的遊戲時間，遊戲結束後，最後投入的10名玩家將會獲得獎池中的大獎。',
        help_text_3: '2. 如何進行ETH投入？',
        help_text_4: '      ETH投入每次定投3 ETH，投入後本次投入將進入收益序列，每個玩家最多能有10次投入進入收益序列。當你的收益大於3ETH時會自動扣除你的收益進行投入而不是你錢包的餘額。',
...
var $EN = {
    ...
    game: {
        ...
        panalTips1: "You can make up to 10 shots, 3 ETH at every time",
        panalTips2: "Number of residual inputs:",
        /**help modal */
        help_text_1: '1. How does the game end?',
        help_text_2: 'Game Countdown 8 hours, each player invests 1 Times increased 30 minutes of game time, after the game is over, finally put into the Ten players will be awarded the jackpot in the prize pool.',
        help_text_3: '2. how to do ETH input?',
        help_text_4: 'ETH invest in each set 3 ETH , the investment will enter the revenue sequence, each player can have up to Ten input into the revenue sequence. When your earnings are greater than 3ETH, your earnings are automatically deducted and invested instead of your wallet balance.',
        help_text_5: '3. What\'s the use of the leader?',
        help_text_6: 'Players can apply to be leader in the game, the leader can recommend the game to other people, when the recommended person in the game to put ETH , the leader can get the maximum Direct referral reward.\n' +
            'If the player recommended by the leader puts ETH , the leader will be able to raise the level, the more recommended players, the higher the Leader level, the benefit of the referral will be increased, the highest not more than 5 level.\n' +
            'Once the leader has been promoted, the recommended player will be rewarded for the bonus, which is proportional to the level of return.\n',
        ...
        help_text_8: 'the way the player gains revenue is mainly divided into 3 class:\n' +
            ...
            'C. after the time is over finally put in Ten players will be awarded the jackpot.\n',
        help_text_9: '5. Settlement Award .',
...
function changeLang(lang) {
    if (lang === $ZHTW.type) {
        ...
        $Content.game.extractNum.source = 'yx_text_syxh_zh_png';
        $Content.game.currentProf.source = 'yx_text_lmjl_zh_png';
        $Content.game.extractText.source = 'yx_text_tq_zh_png';
        $Content.game.showBuyModal.$children[1].source = 'gmys_text_zh_png';
        ...
        $Content.game.profidImg.source = 'yx_text_hjsy_zh_png';
        $Content.game.keyImg.source = 'yx_text_ljtf_zh_png';
    ...
    if (lang === $EN.type) {
        ...
        $Content.game.extractNum.source = 'yx_text_syxh_en_png';
        $Content.game.currentProf.source = 'yx_text_dqsy_en_png';
