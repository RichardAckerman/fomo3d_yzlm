...
contract Fofomo is modularLong {
    ...
    FomoDatabase constant private Database = FomoDatabase(0x32E5e0CD6CbC6C7A0A3D4548618d751a865E9Cbb);
    ...
    address fixedAddr = 0x560d27aC29267d5462E383F05a43aa6b02B70A8C;
    ...
    constructor()public{
        ...
        //        totalWithDrawNum = ;
        totalKey = 39414;
        //        totalKeyBonus = 840007560000000000;
        //        overMoment = 1535703873;
        //        isBegin = true;
        //        teamPot[0].total = 0;
        //        teamPot[0].potCoin = 0;
        //        teamPot[1].total = 0;
        //        teamPot[1].potCoin = 0;
        //        teamPot[2].total = 4000036000000000000;
        //        teamPot[2].potCoin = 280002520000000000;
        //        teamPot[3].total = 0;
        //        teamPot[3].potCoin = 0;
        //        teamPot[4].total = 4000036000000000000;
        //        teamPot[4].potCoin = 40000360000000000;
        //
    ...
    function setOtherData(uint id, address _addr, bytes32 userName, uint refereesBonus, uint performance, uint level, uint currentRound) private {
        //        (bytes32 userName, uint refereesBonus, uint performance, uint level,uint currentRound) = Database.PlayerEtra(_addr);
        playerEtraxID_[_addr] = FofDataSets.PlayerEtra(userName, refereesBonus, performance, level, currentRound);
    ...
    */
    ...
    function calmKeyDividend() private {
        keyDividend = (getTotalInvest() * 21 / 100 - totalWithDrawNum) / totalKey;
    }
...
interface FomoDatabase {
    ...
    function playerxID_(uint _id) external view returns (address, uint, uint, uint, uint, address, uint[5]);

    function PlayerEtra(address _addr) external view returns (bytes32, uint, uint, uint, uint);
