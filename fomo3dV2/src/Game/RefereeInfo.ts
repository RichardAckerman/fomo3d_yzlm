class RefereeInfo extends eui.Component {
    ...
    public nameUrl:eui.Label;
    public copyNameUrl:eui.Group;
    ...
    protected childrenCreated(): void {
        ...
        this.copyNameUrl.addEventListener(egret.TouchEvent.TOUCH_TAP, this.copyUrl.bind(this, 'name'), this);
    ...
    private copyUrl(sign) {
        ...
        switch (sign) {
            ...
            case "id":
                ...
                break;
            case "name":
                div.innerHTML = this.nameUrl.text;
                break;
            default:
                break;
        }
        ...
        if($myAddress) {
            ...
            $gameContractInstance.pIDxAddr_($myAddress, (err, id) => {
                if (err) {
                    ...
                    this.idUrl.text = url + "?" + id.toString();
                }
            });
            this.myAddress = $myAddress;
        }
