...
var Main = (function (_super) {
                    ...
                    case 1:
                        ...
                        getNetWork().then(function () {
                            getJson().then(function (data) {
                                ...
                                getLanStatus();
                                setTimeout(function () {
                                    _this.startLoad(_this.getRandomIndex());
                                }, 1000);
                            });
                        });
                        return [2 /*return*/];
    ...
    Main.prototype.startLoad = function (i) {
        //创建 Sound 对象
        var sound = new egret.Sound();
        // let url: string = "./contract/" + this.misicList[i];
        var url = "./contract/bgm.mp3";
        //添加加载完成侦听
    ...
    Main.prototype.onSoundComplete = function (event) {
        var _this = this;
    ...
    Main.prototype.getRandomIndex = function () {
        var len = this.misicList.length;
        var ron = Math.floor(Math.random() * len);
