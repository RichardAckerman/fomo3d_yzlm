...
var LuckyUnitTs = (function (_super) {
    ...
    LuckyUnitTs.prototype.getData = function () {
        ...
        $gameContractInstance.luckyPotMoney(function (err3, coin) {
            if (err3) {
                console.log("luckyPotMoney", err3);
            }
            else {
                _this.luckyMoney = $toFixedDecimal(coin);
                _this.getQueueId(0);
            }
        });
    };
    LuckyUnitTs.prototype.getQueueId = function (i) {
        var _this = this;
        // 查幸运玩家的id列表
