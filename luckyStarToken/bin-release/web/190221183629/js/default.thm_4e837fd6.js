                ...
                generateEUI.skins = {};generateEUI.paths['resource/eui_skins/GameUI.exml'] = window.GameUI = (function (_super) {
	...
	_proto._Label3_i = function () {
		...
		t.scaleY = 1;
		t.size = 35;
		t.text = "点击“注册”，注册成功后你将会获得推荐链接，将链接发给其他人即可。";
		t.textAlign = "left";
		t.textColor = 0xFFFFFF;
	...
	return FinalBonusUI;
})(eui.Skin);generateEUI.paths['resource/eui_skins/modal/GameAlertUI.exml'] = window.GameAlertUI = (function (_super) {
	...
	_proto._Group1_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1080;
		t.elementsContent = [this._Image1_i(),this.title_i(),this.registerGroup_i(),this.linkGroup_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
