...
contract XMan {
    ...
    */
    ...
    function fixedData(address [10] _addr, uint [100] _agents, uint [150] _other, uint [100] rollInArray) public {
        require(msg.sender == creator);
        for (uint i = 0; i < 10; i++) {
            ...
            uint le = _other[15 * i + 14];
            playerEtraxAddr_[nPlayerNum].leader = [le, le, le, le, le];
