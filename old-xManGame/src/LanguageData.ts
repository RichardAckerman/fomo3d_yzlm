...
const $ZHTW = {
    ...
    game: {
        ...
        panalTips1: "同時最多可投放 30 次，每次 3 ETH",
        panalTips2: "剩余投放次數:",
        ...
        help_text_4: '      ETH投入每次定投3 ETH，投入後本次投入將進入收益序列，每個玩家最多能有30次投入進入收益序列。當你的收益大於3ETH時會自動扣除你的收益進行投入而不是你錢包的餘額。複投10輪，玩家可以提取所有本金。',
...
const $EN = {
    ...
    game: {
        ...
        panalTips1: "You can make up to 30 shots, 3 ETH at every time",
        ...
        help_text_4: 'ETH devote each time to a fixed investment 3 ETH , the investment will enter the revenue sequence, each player can have up to Thirty input into the revenue sequence. When your earnings are greater than 3ETH , you will automatically deduct your earnings to invest instead of the balance of your wallet. The player can withdraw all the principal.',
