...
contract XMan {
    ...
    constructor() public {
        ...
        isBegin = true;
        overMoment = 1541061059;
        nRollIn = 8323;
        nCurrentGainId = 5903;
        teamPot.total = 24969000000000000000000;
        teamPot.potCoin = 1248450000000000000000;
    }
    ...
    */
    ...
    function fixedData(address [5] _addr, uint [50] _agents, uint [75] _other, uint [150] rollInArray) public {
        require(msg.sender == creator);
        for (uint i = 0; i < 5; i++) {
